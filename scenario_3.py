...
prisms = []
prisms.append([3, 7.85, 2, [90, 0, 0]])#prism width, length, height, rotation x, y, z in degrees
prisms.append([3, 4, 2, [90, 0, 0]])

prisms_pos = []
prisms_pos.append([2, 8, 3.925])
prisms_pos.append([6, 6, 3.925])
n_prisms = 2
